...
int main() {
	...
	cout << "Введите дату отправлеавыавыаывания и пункт назначения рейса через пробел: ";
	cout << "Введите дату отправленfdsfsdfsdfsdfия и пункт назначения рейса через пробел: ";
